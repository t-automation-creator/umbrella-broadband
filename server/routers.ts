...
- imagePrompt: A detailed image generation prompt (80-120 words) for creating a tech-infused, web-optimized featured image at 1600x900 pixels (16:9 ratio). The image MUST include: 1) Tech elements relevant to the topic (fibre optic cables with light trails, network routers, ethernet connections, WiFi signals, server racks, or connectivity symbols), 2) The specific technology solution mentioned in the content (e.g., "managed WiFi", "full fibre", "VoIP", "cyber security"), 3) Professional corporate aesthetic with blues, teals, and whites. Style: modern tech photography or sleek digital illustration with depth and lighting effects. Always end with "tech-infused, web-optimized for desktop and mobile, 1600x900 pixels, 16:9 ratio, high quality, professional corporate aesthetic".
...
- imagePrompt: A detailed image generation prompt (80-120 words) for creating a tech-infused, web-optimized featured image at 1600x900 pixels (16:9 ratio). The image MUST include: 1) The CLIENT NAME displayed professionally and elegantly (as subtle text overlay, signage, or branded element), 2) Tech elements showing the solution (fibre optic cables, network infrastructure, WiFi signals, routers, or connectivity symbols integrated into the scene), 3) The client's industry setting (e.g., student accommodation building, healthcare facility, office, retail space), 4) Professional corporate aesthetic with blues, teals, and whites. Style: modern tech-corporate photography with the client name visible as part of the composition. Always end with "featuring [CLIENT NAME], tech-infused, web-optimized for desktop and mobile, 1600x900 pixels, 16:9 ratio, high quality, professional corporate aesthetic".
