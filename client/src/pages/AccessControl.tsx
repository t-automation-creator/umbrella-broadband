  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative py-20 lg:py-28 bg-gradient-to-br from-[#1e3a5f] via-[#2d4a6f] to-[#1e3a5f] text-white overflow-hidden">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-20 left-10 w-32 h-32 border border-amber-500/20 rounded-full"></div>
            <div className="absolute bottom-20 right-20 w-48 h-48 border border-amber-500/20 rounded-full"></div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:flex justify-center">
                <div className="relative">
                  <div className="w-80 h-80 bg-gradient-to-br from-amber-500/20 to-blue-600/20 rounded-full flex items-center justify-center border border-amber-500/30">
                    <div className="w-60 h-60 bg-gradient-to-br from-amber-500/30 to-blue-600/30 rounded-full flex items-center justify-center border border-amber-400/40">
                      <DoorOpen className="w-24 h-24 text-amber-400" />
                    </div>
                  </div>
                  <div className="absolute top-0 left-1/2 w-3 h-3 bg-amber-400 rounded-full animate-ping"></div>
