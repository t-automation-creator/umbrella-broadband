  ...
  const sectors = [
    {
      ...
      image: "/images/sectors/landlords.webp",
    ...
    },
    {
      ...
      image: "/images/sectors/developers.webp",
    ...
    },
    {
      ...
      image: "/images/sectors/business.webp",
    ...
    },
    {
      ...
      image: "/images/sectors/student.webp",
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[400px] lg:min-h-[500px] flex items-center text-white overflow-hidden">
          ...
          <picture className="absolute inset-0">
            <source media="(min-width: 768px)" srcSet="/images/sectors-hero-desktop.webp" />
            <img 
              src="/images/sectors-hero-mobile.webp" 
