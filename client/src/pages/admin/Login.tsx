...
export default function AdminLogin() {
  ...
  if (sessionLoading) {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-primary via-primary/95 to-primary/90 flex items-center justify-center p-4">
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-primary via-primary/95 to-primary/90 flex items-center justify-center p-4 overflow-auto">
