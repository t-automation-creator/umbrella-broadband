      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          <Link href="/managed-broadband">
            <div className="p-6 sm:p-8 bg-gray-50 rounded-xl hover:shadow-lg transition-all border border-gray-100 cursor-pointer group h-full">
              ...
              <p className="text-sm sm:text-base text-gray-600 font-sans mb-3 sm:mb-4">
